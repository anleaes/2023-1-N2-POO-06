...
class Sistema(models.Model):
    ...
    prontuario = models.ForeignKey(Prontuario, verbose_name='Prontuario', on_delete=models.CASCADE)
    ...
    def str(self):
        return f"Paciente: {self.paciente.name}, Médico: {self.medico.nome}, Prontuário: {self.prontuario}"
